...
def do_plot(self,dir_extr,filename,new_folder,tstep,plot_on=True):
    if plot_on==True:
        ...
        if plot_on==True:    
            ...
            save_titles.append('PAA_overview')
            plt.subplots_adjust(hspace=0.6,wspace=0.2)
            for i in range(0,len(ax)):
                for j in range(0,3):
            ...
            save_titles.append('Breathing_angles')
            ...
            save_titles.append('rel_velocity')
            plt.subplots_adjust(hspace=0.6,wspace=0.2)
            for i in range(0,3):
                x = t_plot/day2sec
            ...
            if show_PAA_estimate:
                ...
                save_titles.append('PAA_estimate')
                plt.subplots_adjust(hspace=0.6,wspace=0.2)
